...
- [ ] 按“研究、撰写、翻译、配图、SEO、核验”顺序逐篇完成 100 篇文章
- [ ] 研究 2026 年电子烟趋势关键词集群与可信英文来源
- [ ] 建立 100 个主题的关键词、搜索意图、来源与内部链接计划
- [ ] 逐篇撰写 100 篇原创英文文章并完成德文、阿拉伯文版本
- [ ] 为 100 篇文章生成、上传并检查主题配图
- [ ] 为全部文章接入 SEO 元数据、JSON-LD、独立 URL 与 Sitemap
- [ ] 逐篇验证文章质量、关键词布局、图片、抓取入口与多语言字段
- [ ] 运行构建、测试和线上验收
- [ ] 保存 checkpoint
...
- [x] 将首批十篇的发布日期写入内容库
- [ ] 为后续待创建文章逐篇写入每周十篇的发布日期
- [ ] 让列表、详情、SSR、JSON-LD 与 Sitemap 只输出到期文章
- [ ] 验证首批十篇可见及后续批次按日期自动开放
- [ ] 保存 checkpoint
